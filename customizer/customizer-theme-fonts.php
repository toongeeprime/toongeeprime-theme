...
function prime2g_use_google_fonts() { return get_theme_mod( 'prime2g_use_theme_google_fonts', '1' ); }
...
function prime2g_customizer_theme_fonts( $wp_customize ) {
	 ...
	 */
	$wp_customize->add_setting( 'prime2g_use_theme_google_fonts',
		array( 'type' => 'theme_mod', 'transport' => 'postMessage', 'default' => '1', 'sanitize_callback' => 'sanitize_text_field' )
	);
	$wp_customize->add_control( 'prime2g_use_theme_google_fonts', array(
	...
	$wp_customize->add_setting( 'prime2g_site_headings_font',
		array( 'type' => 'theme_mod', 'default' => $headFont, 'sanitize_callback' => 'sanitize_text_field' )
	);
	$wp_customize->add_control( 'prime2g_site_headings_font', array(
	...
	$wp_customize->add_setting( 'prime2g_site_body_font',
		array( 'type' => 'theme_mod', 'default' => $bodyFont, 'sanitize_callback' => 'sanitize_text_field' )
	);
	$wp_customize->add_control( 'prime2g_site_body_font', array(
	 ...
	 *	@since ToongeePrime Theme 1.0.55
	 */
	$wp_customize->add_setting( 'prime2g_body_fallback_fonts',
	[ 'type' => 'theme_mod', 'transport' => 'postMessage', 'default' => $b_AltFont, 'sanitize_callback' => 'sanitize_text_field' ]
	);
	$wp_customize->add_control( 'prime2g_body_fallback_fonts', array(
	...
	$wp_customize->add_setting( 'prime2g_headings_fallback_fonts',
	[ 'type' => 'theme_mod', 'transport' => 'postMessage', 'default' => $h_AltFont, 'sanitize_callback' => 'sanitize_text_field' ]
	);
	$wp_customize->add_control( 'prime2g_headings_fallback_fonts', array(
	...
	$wp_customize->add_setting( 'prime2g_post_title_font_size',
	[ 'type' => 'theme_mod', 'transport' => 'postMessage', 'default' => '2.5', 'sanitize_callback' => 'sanitize_text_field' ]
	);
	$wp_customize->add_control( 'prime2g_post_title_font_size', array(
	...
	$wp_customize->add_setting( 'prime2g_archive_title_font_size',
	[ 'type' => 'theme_mod', 'transport' => 'postMessage', 'default' => '3', 'sanitize_callback' => 'sanitize_text_field' ]
	);
	$wp_customize->add_control( 'prime2g_archive_title_font_size', array(
	...
	$wp_customize->add_setting( 'prime2g_page_titles_font_weight',
	[ 'type' => 'theme_mod', 'transport' => 'postMessage', 'default' => $t_FWeight, 'sanitize_callback' => 'sanitize_text_field' ]
	);
	$wp_customize->add_control( 'prime2g_page_titles_font_weight', array(
	...
	$wp_customize->add_setting( 'prime2g_body_text_font_size',
	[ 'type' => 'theme_mod', 'transport' => 'postMessage', 'default' => '15', 'sanitize_callback' => 'sanitize_text_field' ]
	);
	$wp_customize->add_control( 'prime2g_body_text_font_size', array(
