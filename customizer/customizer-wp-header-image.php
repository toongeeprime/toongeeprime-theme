 ...
 */
	$wp_customize->add_setting( 'prime2g_video_header_placements',
...
if ( prime_child_min_version( '2.1' ) ) {
	 ...
	 *	@since ToongeePrime Theme 1.0.55
	 */
	$wp_customize->add_setting( 'prime2g_pagetitle_over_headervideo',
	 ...
	 */
	$wp_customize->add_setting( 'prime2g_thumb_replace_header',
	 ...
	 */
	$wp_customize->add_setting( 'prime2g_header_img_attachment',
	 ...
	 */
	$wp_customize->add_setting( 'prime2g_header_background_size',
	 ...
	 *	@since ToongeePrime Theme 1.0.55
	 */
	$wp_customize->add_setting( 'prime2g_theme_header_height',
