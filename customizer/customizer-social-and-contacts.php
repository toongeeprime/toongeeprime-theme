...
function prime2g_customizer_socialmedia_and_contacts( $wp_customize ) {
	...
	$wp_customize->add_control( 'prime2g_show_socials_and_contacts', array(
	...
	$wp_customize->add_setting( 'prime2g_facebook_url',
		array( 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'esc_url' )
	);
	$wp_customize->add_control( 'prime2g_facebook_url', array(
	...
	$wp_customize->add_setting( 'prime2g_instagram_url',
		array( 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'esc_url' )
	);
	$wp_customize->add_control( 'prime2g_instagram_url', array(
	...
	$wp_customize->add_setting( 'prime2g_twitter_url',
		array( 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'esc_url' )
	);
	$wp_customize->add_control( 'prime2g_twitter_url', array(
	...
	$wp_customize->add_setting( 'prime2g_youtube_url',
		array( 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'esc_url' )
	);
	$wp_customize->add_control( 'prime2g_youtube_url', array(
	...
	$wp_customize->add_setting( 'prime2g_linkedin_url',
		array( 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'esc_url' )
	);
	$wp_customize->add_control( 'prime2g_linkedin_url', array(
	...
	$wp_customize->add_setting( 'prime2g_tiktok_url',
		array( 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'esc_url' )
	);
	$wp_customize->add_control( 'prime2g_tiktok_url', array(
	...
	$wp_customize->add_setting( 'prime2g_telegram_url',
		array( 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'esc_url' )
	);
	$wp_customize->add_control( 'prime2g_telegram_url', array(
	...
	$wp_customize->add_setting( 'prime2g_contact_email',
	array( 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_email' )
	);
	$wp_customize->add_control( 'prime2g_contact_email', array(
	...
	$wp_customize->add_setting( 'prime2g_contact_address',
	[ 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field' ]
	);
	$wp_customize->add_control( 'prime2g_contact_address', array(
	...
	$wp_customize->add_setting( 'prime2g_contact_phone',
	[ 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field' ]
	);
	$wp_customize->add_control( 'prime2g_contact_phone', array(
	...
	$wp_customize->add_setting( 'prime2g_whatsapp_number',
		[ 'type' => 'theme_mod', 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_text_field' ]
	);
	$wp_customize->add_control( 'prime2g_whatsapp_number', array(
