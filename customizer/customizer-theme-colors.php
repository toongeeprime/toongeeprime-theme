...
if ( ! defined( 'CHILD_BRANDCOLOR' ) ) {
	$wp_customize->add_setting( 'prime2g_primary_brand_color',
		[ 'capability' => 'edit_theme_options', 'default' => $brandClr, 'sanitize_callback' => 'sanitize_hex_color' ]
	);
...
if ( ! defined( 'CHILD_BRANDCOLOR2' ) ) {
	...
	[ 'capability' => 'edit_theme_options', 'default' => $brandClr2, 'sanitize_callback' => 'sanitize_hex_color' ]
	);
	$wp_customize->add_control( new WP_Customize_Color_Control(
...
if ( ! defined( 'CHILD_SITEBG' ) ) {
	...
	[ 'capability' => 'edit_theme_options', 'default' => $bgcolor, 'transport' => 'postMessage', 'sanitize_callback' => 'sanitize_hex_color' ]
	);
	$wp_customize->add_control( new WP_Customize_Color_Control(
...
if ( ! defined( 'CHILD_HEADERBG' ) ) {
	...
	[ 'capability' => 'edit_theme_options', 'default' => $headerbg, 'sanitize_callback' => 'sanitize_hex_color' ]
	);
	$wp_customize->add_control( new WP_Customize_Color_Control(
...
if ( ! defined( 'CHILD_FOOTERBG' ) ) {
	...
	[ 'capability' => 'edit_theme_options', 'default' => $footerbg, 'sanitize_callback' => 'sanitize_hex_color' ]
	);
	$wp_customize->add_control( new WP_Customize_Color_Control(
