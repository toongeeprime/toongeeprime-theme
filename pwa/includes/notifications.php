...
<p class="offline oo_notif off">'. __( 'You are Offline', PRIME2G_TEXTDOM ) .'</p>
<p class="connected oo_notif off">'. __( 'You are Connected', PRIME2G_TEXTDOM ) .'</p>
<p class="online oo_notif off">'. __( 'You are back Online', PRIME2G_TEXTDOM ) .'</p>
</div>';
