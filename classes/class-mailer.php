...
class Prime2gMailer {
	...
	//	Set "From:" headers (These get overridden by theme SMTP)
...
#mail_page{background:#444;padding:40px;}
#in_mail_page{background:#fff;color:#303030;padding:25px;width:90%;border-radius:5px;
max-width:600px;margin:auto;box-shadow:0 20px 25px 5px rgba(0,0,0,0.5);}
